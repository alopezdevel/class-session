          ...
          <div class="row">
            ...
            <nav class="top-nav col-lg-12 col-md-12">
              ...
              <ul class="text-uppercase">
                ...
                <li><a href="#" class="active">Armonia</a></li>
        ...
        if(count($kit_estudio)>0){
          ...
          <div class="flex-row flex-content-row">
            ...
            <div class="content-widget white-bg col-2">
             ...
             <p class="text-right"> <a href="descarga2.php?archivo=<?php  echo $leccion['ruta'];?>" target="_blank" ><i class="fa fa-file-pdf-o"></i> Descargar PDF</a></p>

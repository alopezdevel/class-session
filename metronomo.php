          ...
          <div class="row">
            ...
            <nav class="top-nav col-lg-12 col-md-12">
              ...
              <ul class="text-uppercase">
                ...
                <li><a href="#" class="active">Metronomo con Drums</a></li>
        ...
        for($x = 50 ; $x<= 200 ; $x+=5){?>
          ...
          <div class="flex-row flex-content-row">
            ...
            <div class="content-widget white-bg col-2">
              <h2 class="inline-block"><img alt="" src="<?php  echo "documentos/artistas/DrummerVectorImage.jpg"?>" WIDTH=100 HEIGHT=100><?php echo ' '.$x. " BPM"?></h2><hr>              
              <p class="text-right"> <a href="descarga_btm.php?sub=Pistas_bateria&archivo=<?php  echo $x." bpm.mp3";?>" target="_blank" ><i class="fa fa-music"></i> Descargar Pista</a></p>              
